...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:sOpqxt8vgzjAx9HQoF7kV1TaU79j2/eOgW21DiGDpcI=",
        version = "v0.0.0-20220919214340-03d780f05241",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_google_simhospital",
        importpath = "github.com/google/simhospital",
        sum = "h1:JN+5Qmjjf+kpZdPSvaf1EleKzaocN6qhOkBdrxOfHJw=",
        version = "v0.0.0-20220914161343-881b87b0ea69",
    )
    go_repository(
